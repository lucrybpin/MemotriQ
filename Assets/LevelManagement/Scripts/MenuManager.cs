...
namespace LevelManagement
{
    public class MenuManager :MonoBehaviour
    {
        ...
        [SerializeField]
        private LevelSettingsMenu levelSettingsMenuPrefab;
        [SerializeField]
        private WinMenu winMenuPrefab;
        [SerializeField]
        private PlayMenu playMenuPrefab;
        [SerializeField]
        private ShopMenu shopMenuPrefab;
        ...
        private void InitializeMenus() {
            ...
            //Menu [ ] menuPrefabs = { mainMenuPrefab, settingsMenuPrefab, creditsMenuPrefab, gameMenuPrefab, pauseMenuPrefab, winMenuPrefab, playMenuPrefab };
